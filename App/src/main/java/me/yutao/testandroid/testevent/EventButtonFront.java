...
public class EventButtonFront extends Button {
	private String tag = EventButtonFront.class.getSimpleName();

	public EventButtonFront(Context context) {
		super(context);
	}

	public EventButtonFront(Context context, AttributeSet attrs) {
		super(context, attrs);
		Object t = getTag();
